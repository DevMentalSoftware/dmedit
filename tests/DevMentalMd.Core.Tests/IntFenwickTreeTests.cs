...
public class IntFenwickTreeTests {
    [Fact]
    public void FromValues_PrefixSumsAreCorrect() {
        var tree = IntFenwickTree.FromValues([10, 20, 30, 40, 50]);
    ...
    public void Update_AdjustsValueAndPrefixSums() {
        var tree = IntFenwickTree.FromValues([10, 20, 30]);
    ...
    public void Update_NegativeDelta() {
        var tree = IntFenwickTree.FromValues([100, 200, 300]);
    ...
    public void FindByPrefixSum_SingleElement() {
        var tree = IntFenwickTree.FromValues([42]);
    ...
    public void Rebuild_ReplacesAllContent() {
        var tree = IntFenwickTree.FromValues([1, 2, 3]);
    ...
    public void LargeTree_CorrectBehavior() {
        ...
        var tree = IntFenwickTree.FromValues(values);
